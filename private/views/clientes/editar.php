                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="texto_endereco" class="form-label">Morada <small>(NºPorta, Andar)</small></label>
                                    <input type="text" class="form-control" id="texto_endereco" name="morada_cliente" value="Rua das Flores, nº12, 2ºEsq.">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="texto_cp" class="form-label">Código Postal</label>
                                <input type="text" class="form-control" id="texto_cp" name="cp_cliente" value="4000-123">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="texto_cliente" name="tel_cliente" value="912345678">
                            </div>
                            <div class="col-md-3">
                                <label for="texto_email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="texto_email" name="email_cliente" value="ana.fereira@example.com">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="texto_dnasc" name="dnasc_cliente" value="1990-10-10">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">
