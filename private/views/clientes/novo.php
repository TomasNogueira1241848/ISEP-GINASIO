<?php
// --------------------------------------------------------------------
// SEGURANÇA: Proteção de acesso à página de inserção
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // --------------------------------------------------------------------
    // 2. Limpar espaços antes e depois
    // --------------------------------------------------------------------
    $nome = trim($nome);
    $morada = trim($morada);
    $cp = trim($cp);
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input
                                        ...
                                        id="texto_cidade"
                                        name="cid_cliente"
                                        value="<?= htmlspecialchars($_POST['cid_cliente'] ?? '') ?>"
                                    >
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input
                                        ...
                                        id="texto_cliente"
                                        name="tel_cliente"
                                        value="<?= htmlspecialchars($_POST['tel_cliente'] ?? '') ?>"
                                    >
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="texto_estcivil" name="estaciv_cliente">
                                        <option value="" <?= (($_POST['estaciv_cliente'] ?? '') == '') ? 'selected' : '' ?>>
                                            Escolha uma opção
                                        </option>
                                        <option value="solt" <?= (($_POST['estaciv_cliente'] ?? '') == 'solt') ? 'selected' : '' ?>>
                                            Solteiro
                                        </option>
                                        <option value="casd" <?= (($_POST['estaciv_cliente'] ?? '') == 'casd') ? 'selected' : '' ?>>
                                            Casado
                                        </option>
                                        <option value="ufat" <?= (($_POST['estaciv_cliente'] ?? '') == 'ufat') ? 'selected' : '' ?>>
                                            União de Facto
                                        </option>
                                    </select>
                                </div>
