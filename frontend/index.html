...
<head>
    ...
    <title>ISEP Ginásio</title>
     <!--   favicon -->
        <link rel="shortcut icon" href="assets/img/gym255.png" type="image/png">
    <!-- estilos da página -->
     <!-- Font Awesome (local) -->
...
<section class="container-texto-generico" id="quem-somos">
 ...
 <img src="assets/img/C_e_o_mundo.jpg" alt="Banner do Ginásio"> <a href="#contacto" class="button">Agende uma Consulta</a>
 </div>
</section> 
...
<div class="pessoa">
 ...
 <p>Programas de treino individualizados para atingir seus objetivos.</p> </div>
<div class="servico">
 <i class="fa-solid fa-people-group fa-3x"></i>
 <h3>Aulas de Grupo</h3>
 <p>Diversas modalidades para todos os níveis de condicionamento físico.</p> </div>
<div class="servico">
...
<div class="servico">
 ...
 <h3>Nutrição</h3>
 <p>Planos alimentares personalizados para otimizar seus resultados.</p> </div>
 </div>
</section> 

  <!-- Seção "Conteudo da pagina"- Aulas Grupo -->
...
<section id="contacto">
 <h2>Contacto</h2>
 <p>Entre em contacto conosco para agendar uma consulta ou tirar suas dúvidas.</p> <form id="contactForm">
